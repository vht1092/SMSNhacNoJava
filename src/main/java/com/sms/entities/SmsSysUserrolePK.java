 ...
 */
@Embeddable
public class SmsSysUserrolePK implements Serializable {
	...
	public SmsSysUserrolePK() {
	}
	
	public SmsSysUserrolePK(String iduser, long idrole) {	
		this.iduser = iduser;
		this.idrole = idrole;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SmsSysUserrolePK)) {
			return false;
		}
		SmsSysUserrolePK castOther = (SmsSysUserrolePK)other;
		return 
