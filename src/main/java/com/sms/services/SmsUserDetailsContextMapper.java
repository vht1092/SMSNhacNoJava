...
import com.sms.entities.SmsLdapUserDetails;
import com.sms.entities.SmsSysUser;
import com.vaadin.spring.annotation.SpringComponent;

@SpringComponent
public class SmsUserDetailsContextMapper implements UserDetailsContextMapper {
	@Autowired
	...
	public UserDetails mapUserFromContext(DirContextOperations ctx, String username, Collection<? extends GrantedAuthority> arg2) {
		SmsSysUser sysUser = sysUserService.findByUserid(username.toLowerCase());
		SmsLdapUserDetails userDetails = new SmsLdapUserDetails();
		if (sysUser == null) {
