...
import com.sms.SmsTabType;
import com.sms.components.SystemStatistic;
import com.sms.services.SysTxnService;
...
public class MainView extends HorizontalLayout implements View {
	...
	@PostConstruct
	void init() {
		Page.getCurrent().setTitle("SMS NHẮC NỢ - GHI NHẬN PHẢN HỒI");
		setSizeFull();
...
//			}
	...
	private void addNewTab(final String itemName) {
		try {
			final Class<? extends Component> tabType = SmsTabType.getTabType(itemName).getClassComponent();
